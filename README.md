...
- [Windows - Visual Studio 2019](#environment-visual-studio-16-2019-win64): _develop, run and debug_
- [Visual Studio Code](#environment-visual-studio-code): _develop, run and debug_
- [Docker](#environment-docker): _run only_
